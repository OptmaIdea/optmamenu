# Repositório de Documentação Histórica (Archive)

> [!NOTE]
> Os arquivos nesta pasta `docs/archive/` são **documentos históricos**, relatórios de fase passados, entregáveis legados, diagnósticos e scripts SQL de pré-publicação preservados em seu estado original para fins de auditoria e memória técnica.

## Fonte Autorizada Vigente
...
- `docs/archive/phase-5-8/`: Documentos de encerramento e manuais das Fases 5 a 8.
- `docs/archive/phase-9/`: Documentos, relatórios e análises das subfases 9.x (9.13, 9.14).
- `docs/archive/post-phase-9/`: Documentos pós-Fase 9 (Fundação PDV, Atacado Combinado, Governança de Slugs).
- `docs/archive/handoffs/`: Handoffs de transição e pré-releases passadas.
- `docs/archive/diagnostics/`: Scripts SQL de diagnósticos e dumps de auditoria.
- `docs/archive/releases/`: Relatórios de encerramento de releases e walkthroughs.
- `docs/archive/sql-fixes/`: Scripts SQL de correções históricas.
