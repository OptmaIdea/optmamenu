...
## Fase 5
- consolidação de Produtos com multiestoque
...
- criticidade em duas camadas
- min/max por local
- documentação expandida de RPCs e RLS


## Fase 8 — Comercial inicial
- loja pública por slug
- pedido público com reserva de estoque
- confirmação, cancelamento e conclusão segura de pedidos
- formas de pagamento configuráveis
- formas de entrega configuráveis
- livro diário de caixa inicial
- QR/garçom digital inicial
- clientes 360º e Vida do Cliente
- fidelidade avançada inicial
- dashboard comercial
- segmentos, promoções e comunicações dirigidas
