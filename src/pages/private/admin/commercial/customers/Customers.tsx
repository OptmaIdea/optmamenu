...
interface CustomerRow {
    ...
    phone: string; // ✅ usa "phone" (coerente com o restante do projeto/RPCs)
    email?: string | null;
    birth_date?: string | null;
    created_at: string;
    marketing_consent?: boolean | null;
    loyalty_points?: number | null;
    loyalty_tier?: 'Bronze' | 'Prata' | 'Ouro' | null;
    tags?: string[] | null;
    cpf?: string | null;
}
...
export default function Customers() {
    ...
    const fetchCustomers = useCallback(async () => {
        try {
            ...
            const { data: storeData, error: storeRpcError } = await supabase.rpc(
    ...
    const fetchAddresses = async (customerId: string) => {
        ...
        try {
            ...
            setCustomerAddresses((data as Address[]) || []);
        } catch (err) {
    ...
    const openCustomerDetails = (customer: CustomerRow) => {
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                        Gerencie a base de clientes e visualize estatísticas de fidelidade.
                    </p>
                </div>
            </div>
                ...
                <div className="p-16 text-center flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-black/20 border border-gray-100 dark:border-gray-700">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                        {searchTerm
                            ...
                            : 'Sua lista de clientes aparecerá aqui assim que houver cadastros.'}
                    </p>
                </div>
            ) : (
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                {!!customer.loyalty_tier && (
                                                    <span
                                                        ...
                                                        ${customer.loyalty_tier === 'Ouro'
                                                                ? 'bg-yellow-100 text-yellow-700'
                                                                : customer.loyalty_tier === 'Prata'
                        ...
                        <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center sticky top-0 bg-white dark:bg-gray-800 z-10">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                    Informações apenas para visualização
                                </p>
                            </div>
                            <button
                        ...
                        <div className="p-6 overflow-y-auto space-y-8">
                            ...
                            <div className="flex items-start gap-6">
                                <div className="w-20 h-20 rounded-2xl bg-brand-green/10 dark:bg-brand-green/20 flex items-center justify-center text-brand-green dark:text-brand-mint font-black text-3xl select-none flex-shrink-0">
                                    {(viewCustomer.nickname || viewCustomer.full_name || '?')
                                        .charAt(0)
                                        .toUpperCase()}
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                {showSensitiveData ? (
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <button
                                                            onClick={() => {
                                                                const pin = prompt(
                                                                    'Digite o PIN administrativo para visualizar:'
                                                                );
                                                                if (pin === '1234') {
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 text-gray-700 dark:text-gray-200">
                                                ...
                                                {viewCustomer.birth_date
                                                    ? new Date(viewCustomer.birth_date).toLocaleDateString()
                                                    : '-'}
                                                {viewCustomer.birth_date && (
                                        ...
                                        <div>
                                            ...
                                            <span
                                                className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-bold ${viewCustomer.marketing_consent
                                ...
                                {loadingAddresses ? (
                                    ...
                                    <div className="space-y-3">
                                        {customerAddresses.map((addr) => (
                                            <div
                                                key={addr.id}
                                                className="p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 flex items-start gap-4"
                                            >
                                                <MapPin
                                                    className="text-brand-green mt-1 flex-shrink-0"
                                                    size={20}
                                                />
                                                <div>
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        {addr.is_default && (
                                                            <span className="text-[10px] bg-brand-green text-white px-2 py-0.5 rounded-full font-bold">
                                                                Principal
                                                            </span>
                                                        )}
                                                        {!!addr.label && (
                                ...
                                <div className="space-y-3">
                                    {['VIP', 'Aniversariante', 'Fidelidade Premium', 'Blacklist'].map((tag) => {
                                        ...
                                        return (
                                            <label
                                                key={tag}
                                                className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-gray-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition"
                                            >
                                                <input
                                                    type="checkbox"
                                                    ...
                                                    onChange={async (e) => {
                                                        ...
                                                        setCustomers((prev) =>
                                                            prev.map((c) =>
                                                                c.id === viewCustomer.id ? { ...c, tags: newTags } : c
                                                            )
                                                        );
                                                ...
                                                />
                                                <span
                                                    className={`font-bold ${tag === 'Blacklist'
                                                            ? 'text-red-500'
