          ...
          <tbody>
            {items.map((item) => (
              <tr key={item.id} className="border-t border-gray-100 dark:border-gray-700">
                ...
                <td className="px-4 py-3">{item.requested_qty}</td>
                <td className="px-4 py-3">{item.shipped_qty}</td>
                <td className="px-4 py-3">{item.received_qty}</td>
                <td className="px-4 py-3">{item.divergence_qty}</td>
              </tr>
            ))}
