      ...
      <div className="space-y-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-slate-500">Veja quais pedidos estão comprometendo o saldo disponível em cada local.</p>
          </div>
                ...
                {visibleRows.map((row) => (
                  <tr key={row.reservation_id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3">
                      ...
                      <div className="text-xs text-slate-500">{statusLabel(row.order_status || row.reservation_status)}</div>
                    </td>
                    ...
                    <td className="px-4 py-3">
                      {row.order_id ? (
                        <Link to={`/admin/orders?orderId=${row.order_id}`} className="inline-flex items-center gap-1 font-semibold text-[#1A867A] hover:underline">
