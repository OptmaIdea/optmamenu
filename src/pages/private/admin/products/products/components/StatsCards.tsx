    ...
    return (
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 md:gap-3 mb-6">
            ...
            <div
                ...
                className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md p-2 md:p-3 flex items-center gap-2 md:gap-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer transition-colors"
            >
            ...
            {/* Valor em Estoque */}
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md p-2 md:p-3 flex items-center gap-2 md:gap-3">
