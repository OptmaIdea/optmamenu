...
import { Save, Loader, Search, AlertCircle, CheckCircle, User, Phone, Mail, Building, MapPin, Contact, FileText, ExternalLink } from 'lucide-react';
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className={activeTab === 'corporate' ? 'block space-y-6 animate-fadeIn' : 'hidden'}>
                        ...
                        <div className="pt-6 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Nome da Loja (Marca Visual) <span className="text-red-500">*</span></label>
                                    <input
                                        type="text"
                                        className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-brand-green outline-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition"
                                        value={store.name || ''}
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Link da Loja (Slug) <span className="text-red-500">*</span></label>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => setStore({ ...store, privacy_policy_text: TEMPLATE_PRIVACY_POLICY.replace('[Nome da Loja]', store.name).replace('[Data atual]', new Date().toLocaleDateString()) })}
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => setStore({ ...store, terms_of_use_text: TEMPLATE_TERMS_OF_USE.replace('[Nome da Loja]', store.name) })}
                                        className="text-xs text-brand-green hover:underline font-bold"
                                    >
                                        Preencher com Modelo Padrão
                                    </button>
