...
export default function AccountPlanPage() {
  ...
  function changeSectionFilter(nextFilter: SectionFilter) {
    ...
    setExpanded(new Set(nextFilter === 'entries' ? ['grp_revenue'] : nextFilter === 'exits' ? ['grp_expense'] : nextFilter === 'transfers' ? ['grp_transfers'] : []));
  }
            ...
            <div className="flex w-fit flex-wrap gap-1 rounded-2xl border-b border-gray-200 bg-gray-50 p-1 dark:border-gray-800 dark:bg-gray-950">
              {[
                ...
                <button
                  key={value}
                  type="button"
                  onClick={() => changeSectionFilter(value as SectionFilter)}
