...
export default function PendingReceivablesPanel({
  ...
  const [activeTab, setActiveTab] = useState<CashbookTab>('entries');
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2 rounded-2xl border border-gray-100 bg-white p-1 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <button
          type="button"
