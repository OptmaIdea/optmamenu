    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
          {/* Hero */}
          <div className="bg-gradient-to-br from-[#21A896]/10 to-[#1a867a]/10 px-8 py-12 border-b border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 bg-[#21A896]/20 rounded-2xl">
                <Shield size={32} className="text-[#21A896]" />
              </div>
              <div>
                <h1 className="text-3xl md:text-4xl font-black text-gray-800 dark:text-white font-candara-bold">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">1</span>
                  Informações que Coletamos
                </h2>

                <h3 className="text-lg font-bold text-gray-700 dark:text-gray-300 mb-3">1.1 Informações fornecidas por você:</h3>
                ...
                <h3 className="text-lg font-bold text-gray-700 dark:text-gray-300 mb-3">1.2 Informações coletadas automaticamente:</h3>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">2</span>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">3</span>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">4</span>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-200 dark:border-gray-600">
                        <th className="text-left py-2 font-bold text-gray-700 dark:text-gray-300">Tipo</th>
                        <th className="text-left py-2 font-bold text-gray-700 dark:text-gray-300">Finalidade</th>
                        <th className="text-left py-2 font-bold text-gray-700 dark:text-gray-300">Duração</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-gray-200 dark:border-gray-600">
                        <td className="py-2 text-gray-600 dark:text-gray-400">Essenciais</td>
                        <td className="py-2 text-gray-600 dark:text-gray-400">Autenticação, segurança</td>
                        <td className="py-2 text-gray-600 dark:text-gray-400">Sessão</td>
                      </tr>
                      <tr className="border-b border-gray-200 dark:border-gray-600">
                        <td className="py-2 text-gray-600 dark:text-gray-400">Preferências</td>
                        <td className="py-2 text-gray-600 dark:text-gray-400">Idioma, tema, configurações</td>
                        <td className="py-2 text-gray-600 dark:text-gray-400">1 ano</td>
                      </tr>
                      <tr>
                        <td className="py-2 text-gray-600 dark:text-gray-400">Analíticos</td>
                        <td className="py-2 text-gray-600 dark:text-gray-400">Uso da plataforma, melhorias</td>
                        <td className="py-2 text-gray-600 dark:text-gray-400">30 dias</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">5</span>
                  Seus Direitos (LGPD)
                </h2>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-2">Confirmar existência</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Saber se tratamos seus dados</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-2">Acessar dados</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Solicitar cópia das informações</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-2">Corrigir dados</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Atualizar informações incorretas</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-2">Anonimizar dados</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Bloquear ou eliminar dados</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-2">Portabilidade</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Transferir dados a outro fornecedor</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg">
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-2">Revogar consentimento</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Retirar autorização a qualquer momento</p>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">6</span>
                  Segurança dos Dados
                </h2>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">7</span>
                  Retenção de Dados
                </h2>
                <p className="text-gray-600 dark:text-gray-400">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">8</span>
                  Dados de Menores
                </h2>
                <p className="text-gray-600 dark:text-gray-400">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">9</span>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">10</span>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">11</span>
                  Contato do DPO
                </h2>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-6">
                  <div className="flex items-center gap-4 mb-3">
                    <Mail size={20} className="text-[#21A896]" />
                    <span className="text-gray-700 dark:text-gray-300">dpo@optmaidea.com</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <Globe size={20} className="text-[#21A896]" />
                    <span className="text-gray-700 dark:text-gray-300">www.optmaidea.com/privacy</span>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 bg-[#21A896]/20 rounded-lg flex items-center justify-center text-[#21A896]">12</span>
                  Encarregado pela OptmaIdea
                </h2>
                <div className="bg-gradient-to-br from-[#21A896]/10 to-[#1a867a]/10 rounded-xl p-6">
                  <p className="text-gray-700 dark:text-gray-300 font-bold mb-2">OptmaIdea Tecnologia Ltda.</p>
