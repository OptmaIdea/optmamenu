      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-[#6B6375]/10 dark:border-gray-800 overflow-hidden">
          ...
          <div className="bg-gradient-to-br from-brand-green/10 to-brand-dark/10 px-8 py-12 border-b border-[#6B6375]/10 dark:border-gray-800">
            ...
            <p className="text-[#6B6375] dark:text-gray-400 max-w-2xl">
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <div className="bg-brand-orange/10 p-4 rounded-xl">
                ...
                <p className="text-xs text-[#6B6375] dark:text-gray-400 font-candara">Criptografia de ponta a ponta</p>
              </div>
              <div className="bg-brand-green/10 p-4 rounded-xl">
                ...
                <p className="text-xs text-[#6B6375] dark:text-gray-400 font-candara">Você decide o que compartilhar</p>
              </div>
              <div className="bg-brand-purple/10 p-4 rounded-xl">
                ...
                <p className="text-xs text-[#6B6375] dark:text-gray-400 font-candara">Em conformidade com a lei</p>
              </div>
            </div>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-[#6B6375] dark:text-gray-400 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-[#6B6375] dark:text-gray-400 mb-4">
              ...
              <section className="mb-8">
                ...
                <div className="bg-[#F8F6F2] dark:bg-gray-800/40 border border-[#6B6375]/10 dark:border-gray-850 rounded-xl p-6 mb-4">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-[#6B6375]/10 dark:border-gray-800">
                        <th className="text-left py-2 font-bold text-[#6B6375] dark:text-gray-300">Tipo</th>
                        <th className="text-left py-2 font-bold text-[#6B6375] dark:text-gray-300">Finalidade</th>
                        <th className="text-left py-2 font-bold text-[#6B6375] dark:text-gray-300">Duração</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-[#6B6375]/10 dark:border-gray-800">
                        <td className="py-2 text-[#6B6375] dark:text-gray-400">Essenciais</td>
                        <td className="py-2 text-[#6B6375] dark:text-gray-400">Autenticação, segurança</td>
                        <td className="py-2 text-[#6B6375] dark:text-gray-400">Sessão</td>
                      </tr>
                      <tr className="border-b border-[#6B6375]/10 dark:border-gray-800">
                        <td className="py-2 text-[#6B6375] dark:text-gray-400">Preferências</td>
                        <td className="py-2 text-[#6B6375] dark:text-gray-400">Idioma, tema, configurações</td>
                        <td className="py-2 text-[#6B6375] dark:text-gray-400">1 ano</td>
                      </tr>
                      <tr>
                        <td className="py-2 text-[#6B6375] dark:text-gray-400">Analíticos</td>
                        <td className="py-2 text-[#6B6375] dark:text-gray-400">Uso da plataforma, melhorias</td>
                        <td className="py-2 text-[#6B6375] dark:text-gray-400">30 dias</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                <p className="text-[#6B6375] dark:text-gray-400">
              ...
              <section className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-[#F8F6F2] dark:bg-gray-800/20 border border-[#6B6375]/5 dark:border-gray-850 p-4 rounded-lg">
                    <h4 className="font-bold text-[#2D2A26] dark:text-white text-sm mb-2">Confirmar existência</h4>
                    <p className="text-xs text-[#6B6375] dark:text-gray-400">Saber se tratamos seus dados</p>
                  </div>
                  <div className="bg-[#F8F6F2] dark:bg-gray-800/20 border border-[#6B6375]/5 dark:border-gray-850 p-4 rounded-lg">
                    <h4 className="font-bold text-[#2D2A26] dark:text-white text-sm mb-2">Acessar dados</h4>
                    <p className="text-xs text-[#6B6375] dark:text-gray-400">Solicitar cópia das informações</p>
                  </div>
                  <div className="bg-[#F8F6F2] dark:bg-gray-800/20 border border-[#6B6375]/5 dark:border-gray-850 p-4 rounded-lg">
                    <h4 className="font-bold text-[#2D2A26] dark:text-white text-sm mb-2">Corrigir dados</h4>
                    <p className="text-xs text-[#6B6375] dark:text-gray-400">Atualizar informações incorretas</p>
                  </div>
                  <div className="bg-[#F8F6F2] dark:bg-gray-800/20 border border-[#6B6375]/5 dark:border-gray-850 p-4 rounded-lg">
                    <h4 className="font-bold text-[#2D2A26] dark:text-white text-sm mb-2">Anonimizar dados</h4>
                    <p className="text-xs text-[#6B6375] dark:text-gray-400">Bloquear ou eliminar dados</p>
                  </div>
                  <div className="bg-[#F8F6F2] dark:bg-gray-800/20 border border-[#6B6375]/5 dark:border-gray-850 p-4 rounded-lg">
                    <h4 className="font-bold text-[#2D2A26] dark:text-white text-sm mb-2">Portabilidade</h4>
                    <p className="text-xs text-[#6B6375] dark:text-gray-400">Transferir dados a outro fornecedor</p>
                  </div>
                  <div className="bg-[#F8F6F2] dark:bg-gray-800/20 border border-[#6B6375]/5 dark:border-gray-850 p-4 rounded-lg">
                    <h4 className="font-bold text-[#2D2A26] dark:text-white text-sm mb-2">Revogar consentimento</h4>
                    <p className="text-xs text-[#6B6375] dark:text-gray-400">Retirar autorização a qualquer momento</p>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-8">
                ...
                <div className="bg-[#F8F6F2] dark:bg-gray-800/30 border border-[#6B6375]/10 dark:border-gray-800 rounded-xl p-6">
              ...
              <section className="mb-8">
                ...
                <div className="bg-gradient-to-br from-brand-green/10 to-brand-dark/10 border border-brand-green/15 rounded-xl p-6">
                  ...
                  <p className="text-[#6B6375] dark:text-gray-400 text-sm mb-1 font-candara">
                    CNPJ: 12.345.678/0001-90
                  </p>
                  <p className="text-[#6B6375] dark:text-gray-400 text-sm font-candara">
