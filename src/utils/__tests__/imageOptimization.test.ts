...
describe('imageOptimization Utility', () => {
  ...
  describe('validateImageFile', () => {
    ...
    it('deve rejeitar arquivos acima do limite máximo de bytes', () => {
      ...
      Object.defineProperty(mockHugeFile, 'size', { value: 16 * 1024 * 1024 });

      expect(() => validateImageFile(mockHugeFile)).toThrow('A imagem selecionada é muito grande. Escolha um arquivo de até 15 MB.');
    });
  });
});
