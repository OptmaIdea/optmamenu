...
comment on function public.list_accounts_payable_payment_options_safe(uuid) is
  'Opções mínimas de contas financeiras e formas de pagamento para a UI de Contas a Pagar, sem expor saldos.';
