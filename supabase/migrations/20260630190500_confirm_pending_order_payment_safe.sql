-- POS_9 — Financeiro — confirmar recebimento de pagamento pendente
--
-- Regra:
-- - pedido/venda com pagamento pendente nao compoe saldo;
-- - ao confirmar recebimento, registra forma real de pagamento;
-- - se ja existe lancamento de caixa vinculado e sem saldo, ele passa a compor saldo;
-- - se nao existe lancamento, cria via create_cashbook_entry_from_order;
-- - evita duplicidade de recebimento.
